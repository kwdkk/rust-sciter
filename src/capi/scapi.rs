...
pub struct ISciterAPI
{
  ...
  // #endif
	...
	pub SciterNodeType: extern "system" fn (hnode: HNODE, pNodeType: * mut NODE_TYPE) -> SCDOM_RESULT,
	...
	pub SciterNodeInsert: extern "system" fn (hnode: HNODE, how: NODE_INS_TARGET, what: HNODE) -> SCDOM_RESULT,
